<?php
	...
	uploadFile($_FILES["picturelocation"],$_GET['uid']);
	
	$currentTimeStamp = date('y-m-j H-i-s');
	writeLogFile($currentTimeStamp." : ".$_GET['uid']."has changed profile picture.");
?>
...
<head>
	...
	<title>OES :: Picture changed</title>
...
<table width="738" border="0" align="center" cellpadding="1" cellspacing="1" class="tableBackground">
  ...
  <tr>
    <td height="296"><div align="center"> <div align="center">Your profile picture has been updated! </div></td>
  </tr>
</table>
</body>
</html>
