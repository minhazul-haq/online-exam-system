<?php	
	...
	$result = mysql_query("SELECT * FROM teacher,departments,institutions where is_registered=0 and ".
	"belongs_to_dept=dept_id and belongs_to_institution=institution_id and ".
	"institution_id=(select belongs_to_institution from registrar where registrar_id='".$_GET['uid']."')");
...
<head>
	...
	<title>OES :: View new teacher requests</title>
    ...
    <td height="296"><div align="center">
      <table width="407" border="0">
		...
		<tr>
		  ...
		  action="aproveteacherrequest.php?uid=<?php echo $_GET['uid']; ?>&tid=<?php echo $row['teacher_id']; ?>">
