<?php
	...
	$totalRow = mysql_num_rows(mysql_query("select * from notice_board"));
	
	date_default_timezone_set('Asia/Dhaka');
	$curTimeStamp = date('y-m-d H:i:s');
		
	mysql_query("insert into notice_board values('not".($totalRow+1)."','".$_POST['noticeTitle']."','".
	$_GET['uid']."','".$_POST['noticeData']."','".$curTimeStamp."')"); 
...
<head>
	...
	<title>OES :: Notice created</title>
...
<table width="738" border="0" align="center" cellpadding="1" cellspacing="1" class="tableBackground">
  ...
  <tr>
    <td height="296"><div align="center"> New notice created </div></td>
  </tr>
</table>
</body>
</html>
