<?php	
	...
	$result = mysql_query("SELECT * FROM student,departments where student_id='".
	$_GET['sid']."' and department=dept_id");
...
<head>
	...
	<title>OES :: View student details</title>
    ...
    <td height="296"><div align="center">
      ...
      <table width="376" border="0">
		...
		<tr>
		  ...
		  action="studentaproved.php?uid=<?php echo $_GET['uid']; ?>&sid=<?php echo $_GET['sid']; ?>">
		      <div align="center">
